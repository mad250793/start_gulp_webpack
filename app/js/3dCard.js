// модуль превращающий елементы в 3d елементы реагирущие на курсор мыши!

/// =====как юзать ======

//

card3D.big(element', "-15"); /// для большах катрочек
card3D.small('.list__item', "0"); /// для мелких катрочек
